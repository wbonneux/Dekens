...
<html>
	<head>
		...
		<title><?php echo  $lang ['accu_pagetitle'];?></title>
...
<body id="home">
	<section class="container">
        <div class="content row container">
        	...
        	<h1 class="page-header"><?php echo  $lang ['accu_title'];?></h1>
        	<div class="row">
        		<div class="col-md-12">
        		<iframe style="width:100%;height:100%" src="http://www.husqvarna.com/nl/products/accu-series/husqvarna-accu-series/"></iframe>
        		</div>
        	</div>
