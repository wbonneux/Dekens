...
// 						echo "<span class='label label-success'>Ja</span>";
						echo "<span style='cursor: pointer;' id=active-".$row->id." onclick=setDcInactive(".$row->id.") class='label label-success'>Ja</span>";
					} else {
// 						echo "<span class='label label-error'>Nee</span>";
						echo "<span style='cursor: pointer;' id=inactive-".$row->id." onclick=setDcActive(".$row->id.") class='label label-error'>Nee</span>";
...
// 					echo '<a class="btn btn-danger" href="deleteDaysClosed.php?id='.$row->id.'"><i class="icon-trash icon-white" data-rel="tooltip" title="Verwijderen"></i></a>';
					echo '<a class="btn btn-danger" id="'.$row->id.'"><i onclick="deleteDc('.$row->id.')" class="icon-trash icon-white" data-rel="tooltip" title="Verwijderen"></i></a>';
					echo '</td>';
					echo "</tr>";
				}
				?>
