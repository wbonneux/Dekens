...
if (isset ( $_POST ['fp_title'] )) {
	$_SESSION ['fp_title'] = $_POST ["fp_title"];
}
if (isset ( $_POST ['fp_description'] )) {
	$_SESSION ['fp_description'] = $_POST ["fp_description"];
}
if (isset ( $_POST ['fp_image'] )) {
	$_SESSION ['fp_image'] = $_POST ["fp_image"];
}
if (isset ( $_POST ['fp_image_pos'] )) {
	$_SESSION ['fp_image_pos'] = $_POST ["fp_image_pos"];
}
if (isset ( $_POST ['fp_active'] )) {
	$_SESSION ['fp_active'] = '1';
} else {
	$_SESSION ['fp_active'] = '0';
}
...
checkUploadPhoto ( 'fp_image', $ses_id );
...
if ($validator->validate ( $_POST )) {
	...
	$frontPage->imagePos = $_POST ['fp_image_pos'];
	...
	if (isset ( $frontPage->id )) {
		...
		if (isset ( $_SESSION ['fp_image'] )) {
			saveUploadPhoto ( 'fp_image', $ses_id, $frontPage->id );
		}
