...
if (isset ( $_POST ['pc_category'] )) {
	$_SESSION ['pc_category'] = $_POST ["pc_category"];
}
...
if ($validator->validate ( $_POST )) {
	...
	$prodxCatDAO->deleteProdXCategoryByProduct($product->id);
	...
	if (isset ( $product->id )) {
		...
		if (isset ( $_SESSION ['pc_image'] )) {
			saveUploadPhoto ( 'pc_image', $ses_id, $product->id );
		}
