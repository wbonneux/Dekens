...
if(isset($_POST['sh_price_weekend'])){ $_SESSION['sh_price_weekend'] = $_POST["sh_price_weekend"];}
if(isset($_POST['sh_price_week'])){ $_SESSION['sh_price_week'] = $_POST["sh_price_week"];}
