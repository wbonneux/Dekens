...
if(isset($_POST['sh_image_4'])){ $_SESSION['sh_image_4'] = $_POST["sh_image_4"];}
if(isset($_POST['sh_image_5'])){ $_SESSION['sh_image_5'] = $_POST["sh_image_5"];}
if(isset($_POST['sh_sizetirefront'])){ $_SESSION['sh_sizetirefront'] = $_POST["sh_sizetirefront"];}
if(isset($_POST['sh_sizetireback'])){ $_SESSION['sh_sizetireback'] = $_POST["sh_sizetireback"];}
// echo "setting session<br/>";
// echo 'sh_active(pre): '. $_SESSION["sh_active"].'<br/>';
if(isset($_POST['sh_active'])){$_SESSION['sh_active'] = '1';}else{$_SESSION['sh_active'] = '0';}
if(isset($_POST['sh_sold'])){ $_SESSION['sh_sold'] = '1';}else{$_SESSION['sh_sold'] ='0';}
...
checkUploadPhoto('sh_image_1',$_SESSION['sh_id']);
checkUploadPhoto('sh_image_2',$_SESSION['sh_id']);
checkUploadPhoto('sh_image_3',$_SESSION['sh_id']);
checkUploadPhoto('sh_image_4',$_SESSION['sh_id']);
checkUploadPhoto('sh_image_5',$_SESSION['sh_id']);
