<form method="POST"
		...
		<div class="col-lg-9">
			<div class="form-group">
		              	<?php
																	...
																	?>
		                  <textarea name="fp_description" class="form-control"
					rows="15" id="fp_description"><?php if(isset($_SESSION['fp_description'])){echo $_SESSION['fp_description'];}?></textarea>
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-lg-3">
			<label for="fp_image"><?php echo $lang['fp_image']; ?></label> <input
				type="file" name="fp_image" id="fp_image" class="form-control"><br>
		</div>
		...
		<div class="col-lg-4">
			<div class="form-group">
				...
				<select class="form-control" id="fp_image_pos" name="fp_image_pos">
					<option value='null'><?php echo $lang['SELECT_POS']; ?></option>
					<?php
					
					if (isset ( $_SESSION ['fp_image_pos'] ) & $_SESSION ['fp_image_pos'] == 'left') {
						echo '<option selected value="left">Links</option>';
					} else {
						echo '<option value="left">Links</option>';
					}
					if (isset ( $_SESSION ['fp_image_pos'] ) & $_SESSION ['fp_image_pos'] == 'right') {
						echo '<option selected value="right">Rechts</option>';
					} else {
	...
	<div class="row">
		...
		<div class="form-group col-lg-12">
			<input type="hidden"
				value="<?php if(isset($_REQUEST['id'])){$_REQUEST['id'];}?>"
				id="fp_id" name="fp_id">
