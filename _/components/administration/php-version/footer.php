		...
		<div class="modal hide fade" id="myModal">
			...
			<form action="nieuws.php?action=add" method="POST" role="form" enctype="multipart/form-data">
			<?php 
		...
		<footer>
			<p class="pull-left">&copy; <a mailto="info@webbositedesign.be" target="_blank">Bonneux Wim</a> <?php echo date('Y') ?></p>
			<p class="pull-right">Powered by: <a href="http://webbositedesign.be">WebBo Software</a></p>
		</footer>
		<?php } ?>
