 ...
 */
class SectionsMySqlDAO implements SectionsDAO{
	...
	public function queryAllOrderBy($orderColumn){
		$sql = 'SELECT * FROM sections ORDER BY '.$orderColumn;
		$sqlQuery = new SqlQuery($sql);
		return $this->getList($sqlQuery);
	}
	...
	public function insert($section){
		$sql = 'INSERT INTO sections (title, name, image, scope, image_position, description, published, checked_out, checked_out_time, ordering, access, count, params) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)';
		$sqlQuery = new SqlQuery($sql);
	...
	public function update($section){
		$sql = 'UPDATE sections SET title = ?, name = ?, image = ?, scope = ?, image_position = ?, description = ?, published = ?, checked_out = ?, checked_out_time = ?, ordering = ?, access = ?, count = ?, params = ? WHERE id = ?';
		$sqlQuery = new SqlQuery($sql);
	...
	public function queryByImage($value){
		$sql = 'SELECT * FROM sections WHERE image = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->set($value);
		return $this->getList($sqlQuery);
	}
	...
	public function queryByScope($value){
		$sql = 'SELECT * FROM sections WHERE scope = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->set($value);
		return $this->getList($sqlQuery);
	}
	...
	public function queryByImagePosition($value){
		$sql = 'SELECT * FROM sections WHERE image_position = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->set($value);
		return $this->getList($sqlQuery);
	}
	...
	public function queryByDescription($value){
		$sql = 'SELECT * FROM sections WHERE description = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->set($value);
		return $this->getList($sqlQuery);
	}
	...
	public function queryByPublished($value){
		$sql = 'SELECT * FROM sections WHERE published = ?';
		$sqlQuery = new SqlQuery($sql);
	...
	public function queryByCheckedOut($value){
		$sql = 'SELECT * FROM sections WHERE checked_out = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->setNumber($value);
		return $this->getList($sqlQuery);
	}
	...
	public function queryByCheckedOutTime($value){
		$sql = 'SELECT * FROM sections WHERE checked_out_time = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->set($value);
		return $this->getList($sqlQuery);
	}
	...
	public function queryByOrdering($value){
		$sql = 'SELECT * FROM sections WHERE ordering = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->setNumber($value);
		return $this->getList($sqlQuery);
	}
	...
	public function queryByAccess($value){
		$sql = 'SELECT * FROM sections WHERE access = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->setNumber($value);
		return $this->getList($sqlQuery);
	}
	...
	public function queryByCount($value){
		$sql = 'SELECT * FROM sections WHERE count = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->setNumber($value);
		return $this->getList($sqlQuery);
	}
	...
	public function queryByParams($value){
		$sql = 'SELECT * FROM sections WHERE params = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->set($value);
		return $this->getList($sqlQuery);
	}
	...
	public function deleteByName($value){
		$sql = 'DELETE FROM sections WHERE name = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->set($value);
		return $this->executeUpdate($sqlQuery);
	}
	...
	public function deleteByImage($value){
		$sql = 'DELETE FROM sections WHERE image = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->set($value);
		return $this->executeUpdate($sqlQuery);
	}
	...
	public function deleteByScope($value){
		$sql = 'DELETE FROM sections WHERE scope = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->set($value);
		return $this->executeUpdate($sqlQuery);
	}
	...
	public function deleteByImagePosition($value){
		$sql = 'DELETE FROM sections WHERE image_position = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->set($value);
		return $this->executeUpdate($sqlQuery);
	}
	...
	public function deleteByDescription($value){
		$sql = 'DELETE FROM sections WHERE description = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->set($value);
		return $this->executeUpdate($sqlQuery);
	}
	...
	public function deleteByPublished($value){
		$sql = 'DELETE FROM sections WHERE published = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->setNumber($value);
		return $this->executeUpdate($sqlQuery);
	}
	...
	public function deleteByCheckedOut($value){
		$sql = 'DELETE FROM sections WHERE checked_out = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->setNumber($value);
		return $this->executeUpdate($sqlQuery);
	}
	...
	public function deleteByCheckedOutTime($value){
		$sql = 'DELETE FROM sections WHERE checked_out_time = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->set($value);
		return $this->executeUpdate($sqlQuery);
	}
	...
	public function deleteByOrdering($value){
		$sql = 'DELETE FROM sections WHERE ordering = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->setNumber($value);
		return $this->executeUpdate($sqlQuery);
	}
	...
	public function deleteByAccess($value){
		$sql = 'DELETE FROM sections WHERE access = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->setNumber($value);
		return $this->executeUpdate($sqlQuery);
	}
	...
	public function deleteByCount($value){
		$sql = 'DELETE FROM sections WHERE count = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->setNumber($value);
		return $this->executeUpdate($sqlQuery);
	}
	...
	public function deleteByParams($value){
		$sql = 'DELETE FROM sections WHERE params = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->set($value);
		return $this->executeUpdate($sqlQuery);
	}
