    	...
    	<section class="container">
            <div class="content row container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 portfolio-item"> <a href="FotoAlbumDetail.php"> <img class="img-responsive" src="http://placehold.it/700x400"/> </a>
                    <h3> <a href="FotoAlbumDetail.php">Project Name</a> </h3>
